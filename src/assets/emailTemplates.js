                                        ...
                                        <tbody>
                                          <tr>
                                            <td align="center" class="esd-block-text es-infoblock">
                                              <p>
                                                <a target="_blank">
<strong>© 2025 Developer. All rights reserved.</strong>
                                        ...
                                        <tbody>
                                          <tr>
                                            <td align="center" class="esd-block-image es-p20b" style="font-size:0px">
                                              <a target="_blank">
                                                <img src="https://fkbbhts.stripocdn.email/content/guids/CABINET_887f48b6a2f22ad4fb67bc2a58c0956b/images/93351617889024778.png" alt="Logo" width="200" title="Logo" style="display:block;font-size:12px">
                                              </a>
                                            </td>
                                          </tr>
                                        </tbody>
                                        ...
                                        <tbody>
                                          <tr>
                                            <td align="center" class="esd-block-image es-p10t es-p10b" style="font-size:0px">
                                              <a target="_blank">
                                                <img src="https://fkbbhts.stripocdn.email/content/guids/CABINET_67e080d830d87c17802bd9b4fe1c0912/images/55191618237638326.png" alt="" width="100" style="display:block">
                                              </a>
                                            </td>
                                          </tr>
                                          <tr>
                                          ...
                                          <tr>
                                            <td align="center" class="esd-block-text es-p5t es-p5b es-p40r es-p40l es-m-p0r es-m-p0l">
                                              <p>
                                                Hi, You’ve received this message because your email address has been registered with our site. Please enter the verification code below to verify your email address and confirm that you are the owner of this account.
                                              </p>
                                            </td>
                                          </tr>
                                          <tr>
                                            <td align="center" class="esd-block-text es-p10t es-p5b">
                                              <p>
                                                Here is your <strong>VERIFICATION CODE</strong>
                                              </p>
                                            </td>
                                          </tr>
                                          <tr>
                                            <td align="center" class="esd-block-button es-p10t es-p10b">
                                              <span class="es-button-border" style="border-radius:6px">
                                                <p href="" target="_blank" class="es-button" style="padding-left:30px;padding-right:30px;border-radius:6px; font-size: 20px; font-weight: bold; color: #000;">
                                                  {{otp}}
                                                </p>
                                              </span>
                                            </td>
                                        ...
                                        <tbody>
                                                  ...
                                                  <tr>
                                                    <td align="center" valign="top" class="es-p40r">
                                                      <a target="_blank" href="">
                                                        <img title="Facebook" src="https://fkbbhts.stripocdn.email/content/assets/img/social-icons/logo-black/facebook-logo-black.png" alt="Fb" width="32">
                                                      </a>
                                                    </td>
                                                    <td align="center" valign="top" class="es-p40r">
                                                      <a target="_blank" href="">
                                                        <img title="X" src="https://fkbbhts.stripocdn.email/content/assets/img/social-icons/logo-black/x-logo-black.png" alt="X" width="32">
                                                      </a>
                                                    </td>
                                                    <td align="center" valign="top" class="es-p40r">
                                                      <a target="_blank" href="">
                                                        <img title="Instagram" src="https://fkbbhts.stripocdn.email/content/assets/img/social-icons/logo-black/instagram-logo-black.png" alt="Inst" width="32">
                                                      </a>
                                                    </td>
                                                    <td align="center" valign="top">
                                                      <a target="_blank" href="">
                                                        <img title="Youtube" src="https://fkbbhts.stripocdn.email/content/assets/img/social-icons/logo-black/youtube-logo-black.png" alt="Yt" width="32">
                                                      </a>
                                                    </td>
                                                  </tr>
                                                </tbody>
                                          ...
                                          <tr>
                                            <td align="center" class="esd-block-text es-p35b">
                                              ...
                                              <p>
                                                Vaishnavi Summit, Ground Floor, 3rd Block, Koramangala Industrial Layout, Bangalore KA 560034 IN.
                                              </p>
                                            </td>
                                          </tr>
                                          <tr>
                                            <td esd-tmp-menu-padding="5|5" esd-tmp-divider="1|solid|#cccccc" esd-tmp-menu-color="#999999" class="esd-block-menu">
                                              <table cellpadding="0" cellspacing="0" width="100%" class="es-menu">
                                                <tbody>
                                                  <tr>
                                                    <td align="center" valign="top" width="100.00%" class="es-p10t es-p10b es-p5r es-p5l esd-block-menu-item" style="padding-top:5px;padding-bottom:5px">
                                                      <div>
                                                        <a target="_blank" href="http://localhost:5173/" style="color:#999999">
                                                          Visit Us
                                                        </a>
                                                      </div>
                                                    </td>
                                      ...
                                      <table cellpadding="0" cellspacing="0" width="100%">
                                        <tbody>
                                          ...
                                          <tr>
                                            <td align="center" class="esd-block-text es-p5t es-p5b es-p40r es-p40l es-m-p0r es-m-p0l">
                                              <p>
                                                Hi, You’ve received this message because your email address has been registered with our site. Please use the code below to change your password.
                                              </p>
                                            </td>
                                          </tr>
                                          <tr>
                                          ...
                                          <tr>
                                            <td align="center" class="esd-block-button es-p10t es-p10b">
                                              <span class="es-button-border" style="border-radius:6px">
                                                <p href="" target="_blank" class="es-button" style="padding-left:30px;padding-right:30px;border-radius:6px">
                                                  {{otp}}
                                                </p>
                                              </span>
                                            </td>
